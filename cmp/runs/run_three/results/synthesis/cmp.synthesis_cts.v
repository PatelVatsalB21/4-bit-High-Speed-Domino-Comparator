module cmp (VGND,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_15 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a2bb2o_1 _06_ (.A1_N(net6),
    .A2_N(net2),
    .B1(net6),
    .B2(net2),
    .X(_00_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a2bb2o_1 _07_ (.A1_N(net7),
    .A2_N(net3),
    .B1(net7),
    .B2(net3),
    .X(_01_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a2bb2o_1 _08_ (.A1_N(net5),
    .A2_N(net1),
    .B1(net5),
    .B2(net1),
    .X(_02_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a2bb2o_1 _09_ (.A1_N(net8),
    .A2_N(net4),
    .B1(net8),
    .B2(net4),
    .X(_03_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _10__1 (.A(clk),
    .Y(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a41o_2 _11_ (.A1(_00_),
    .A2(_01_),
    .A3(_02_),
    .A4(_03_),
    .B1(net10),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _12__2 (.A(_05_),
    .Y(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 input8 (.A(B[3]),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_1 output9 (.A(net11),
    .X(out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
